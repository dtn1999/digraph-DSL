...
import de.monticore.ast.ASTCNode;
 ...
 protected  Optional<graphqllite._symboltable.TypeSymbol> delegate = Optional.empty();
...
this.enclosingScope = enclosingScope;
...

 {
  ...
  if(!delegate.isPresent()){
    Log.debug("Load full information of '" + name + "' (Kind " + "graphqllite._symboltable.TypeSymbol" + ").", TypeSymbolSurrogate.class.getSimpleName());
    if(!(this.enclosingScope instanceof graphqllite._symboltable.IGraphQLLiteScope)){
      Log.error("0xA4071x50822 The enclosingScope needs to be a subtype of graphqllite._symboltable.IGraphQLLiteScope.");
    }
    Optional<graphqllite._symboltable.TypeSymbol> resolvedSymbol = ((graphqllite._symboltable.IGraphQLLiteScope) enclosingScope).resolveType(name);

    if (resolvedSymbol.isPresent()) {
      Log.debug("Loaded full information of '" + name + "' successfully.",
      TypeSymbolSurrogate.class.getSimpleName());
  ...
  return delegate.isPresent();
    ...
    /* generated by template core.Method*/
 public  graphqllite._symboltable.TypeSymbol lazyLoadDelegate ()

 {
      /* generated by template _symboltable.symbolsurrogate.LazyLoadDelegate*/

  if(!delegate.isPresent()){
    com.google.common.base.Preconditions.checkArgument(!com.google.common.base.Strings.isNullOrEmpty(name), " 0xA4070x39865 Symbol name may not be null or empty.");

    Log.debug("Load full information of '" + name + "' (Kind " + "graphqllite._symboltable.TypeSymbol" + ").", TypeSymbolSurrogate.class.getSimpleName());
    if(!(this.enclosingScope instanceof graphqllite._symboltable.IGraphQLLiteScope)){
      Log.error("0xA4070x38903 The enclosingScope needs to be a subtype of graphqllite._symboltable.IGraphQLLiteScope.");
    }
    Optional<graphqllite._symboltable.TypeSymbol> resolvedSymbol = ((graphqllite._symboltable.IGraphQLLiteScope) enclosingScope).resolveType(name);
    ...
    if (resolvedSymbol.isPresent()) {
      ...
      Log.error("0xA1038 " + TypeSymbolSurrogate.class.getSimpleName() + " Could not load full information of '" +
        name + "' (Kind " + "graphqllite._symboltable.TypeSymbol" + ").");
      return this;
    }
  }else{
    return delegate.get();
